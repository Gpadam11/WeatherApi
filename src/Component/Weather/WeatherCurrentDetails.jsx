...
//   bg-no-repeat bg-center bg-cover p-15 m-5rem
//   rounded-lg
//   text-white
//   "
//     >
...
//         </div>
//       </div>
//       <div className="flex justify-center items-center md:pt-5 md:m-1rem sm:pt-2 sm:m-0.5rem">
//         <p className="text-2xl font-bold">
//           {moment().format("dddd, MMMM Do YYYY, h:mm:ss a")}
//         </p>
//       </div>
//       <div className="font-black grid grid-cols-6 gap-2 my-5rem mx-1rem justify-items-center">
